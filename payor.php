...
if(isset($_SESSION['owner_id'])){
	...
	$sql = "SELECT * FROM jcit_owners where owner_id='".$id."';" ;
	$pay = mysqli_query($con,$sql);
    $payor = mysqli_fetch_assoc($pay);
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form method="POST" action="pay.php">
					...
					<input type="text" name="PayorName" id="PayorName" class="input100" value="eBPLS" disabled>
						<span class="focus-input100"></span>
                    </div>
                     <div class="p-t-13 p-b-9">
						<span class="txt1">
					...
					<div class="wrap-input100 validate-input" data-validate = "PayorName is required">
                        <input type="text" name="PayorName" id="PayorName" class="input100" value="<?php if($payor['firstname']=="N/A"){echo $payor['permitee'];}else{echo $payor['firstname'].' '.$payor['middlename'].' '.$payor['lastname'];}?>" disabled>
						<span class="focus-input100"></span>
                    </div>
                    <div class="p-t-13 p-b-9">
						<span class="txt1">
					...
					<div class="wrap-input100 validate-input" data-validate = "PayorEmail is required">
 					<input type="text" name="PayorEmail" class="input100" value="<?php if($payor['email']==""){echo "";}else{echo $payor['email'];} ?>" disabled>
